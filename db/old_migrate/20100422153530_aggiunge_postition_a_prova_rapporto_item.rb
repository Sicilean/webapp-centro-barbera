class AggiungePostitionAProvaRapportoItem < ActiveRecord::Migration
  def self.up
    ...
    add_column   :prova_rapporto_items,  :position, :decimal, :precision => 15
  end

  def self.down
    remove_column :prova_rapporto_items, :position
  end
end
